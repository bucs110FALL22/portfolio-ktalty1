...
font1=pygame.font.SysFont("Times",25)
font2=pygame.font.SysFont("Timess",40)
font3=pygame.font.SysFont("Times",30)
font4=pygame.font.SysFont("Times",50)
...
#Storing scores
def create_score(c,p): #creating score for computer and player
...
#Designing the layout  for table  
def table():
...
def homescreen(c,p): #computer, player
    if c >=5: #if computer wins 
        cpuwin=font4.render("YOU LOSE",True,white)
        screen.blit(cpuwin,(150,250))
    create_score(c,p)
    pygame.display.flip()
  
    if p >=5: #if player wins 
...
upperMallet=Mallet("U",250,100,50,330)
lowerMallet=Mallet("L",250,600,370,650)

def malletU(upperMallet):
